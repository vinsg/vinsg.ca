...
![graphql logo](/assets/slides/graphql-intro/graphql-logo.png) <!-- .element: class="r-stretch" width="20%" style="margin:auto"-->
...
![problem](/assets/slides/graphql-intro/problem-4.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->

--

![problem](/assets/slides/graphql-intro/problem-3.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->

--

![problem](/assets/slides/graphql-intro/problem-2.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->

--

![problem](/assets/slides/graphql-intro/problem-1.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->

--

![problem](/assets/slides/graphql-intro/problem-0.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->
...
![solution](/assets/slides/graphql-intro/solution-3.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->

--

![solution](/assets/slides/graphql-intro/solution-2.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->

--

![solution](/assets/slides/graphql-intro/solution-1.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->

--

![solution](/assets/slides/graphql-intro/solution-0.svg) <!-- .element: style="filter: brightness(0) invert(1)" -->
